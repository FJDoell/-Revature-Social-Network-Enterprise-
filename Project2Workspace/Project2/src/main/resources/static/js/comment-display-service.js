...
export class CommentDisplayService {
    ...
    likeCommentById(id) {
        let comment = JSON.parse(`{"commentId":${id},"commentMessage":"Super fighting robot. MEGA MAN!","numOfLikes":3,"commentImage":"","accountId":4,"username":"Agent 47","accountImage":null}`);
